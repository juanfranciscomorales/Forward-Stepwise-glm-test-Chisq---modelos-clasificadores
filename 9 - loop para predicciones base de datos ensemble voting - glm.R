...
for ( i in 1:14) {
        ...
        lista.base.datos[[i]] <- clasificaciones.base.datos.ensemble.voting.glm(base.datos  = lista.drugbank[i],cant.modelos = 100,fraccion.votos = 0.9, x = tabla.sensibilidad.ordenadas)  
}
